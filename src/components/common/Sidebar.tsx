    ...
    <aside className={`hidden lg:flex flex-col justify-between border-r border-slate-200/70 bg-white/80 backdrop-blur dark:border-slate-800 dark:bg-slate-950/80 ${collapsed ? 'w-20' : 'w-64'}`}>
      <div>
        <div className="flex items-center gap-3 px-5 py-6">
          ...
          {!collapsed && <div>
            <p className="text-sm font-semibold text-slate-900 dark:text-white">EduIntel AI</p>
      ...
      <div className="border-t border-slate-200 p-4 dark:border-slate-800">
        <button onClick={toggleTheme} className="flex w-full items-center justify-center gap-2 rounded-2xl border border-slate-200 px-3 py-2 text-sm font-semibold text-slate-600 transition hover:bg-slate-100 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800">
