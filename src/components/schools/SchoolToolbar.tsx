...
export const SchoolToolbar = ({ query, total, onQueryChange, onAdd }: SchoolToolbarProps) => (
  <div className="flex flex-col gap-4 rounded-[28px] border border-slate-200/70 bg-white/80 p-6 shadow-sm backdrop-blur dark:border-slate-800 dark:bg-slate-950/80 lg:flex-row lg:items-center lg:justify-between">
    <div>
    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
      ...
      <button onClick={onAdd} className="flex items-center justify-center gap-2 rounded-2xl bg-violet-600 px-4 py-3 font-semibold text-white">
